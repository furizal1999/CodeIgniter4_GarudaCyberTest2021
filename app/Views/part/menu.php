            ...
            <li class="menu-header">Dashboard</li>
              <?php
                if(isset(session()->login_myproject)){
                  if(session()->status_login=="Pimpinan"){
              ?>
                  <li class="nav-item">
                    <a href="<?= site_url("/grafik_tagihan_mahasiswa") ?>"><i class="fas fa-columns"></i> <span>Report Grafik Tagihan</span></a>
                    
                  </li>
              <?php 
                  }elseif(session()->status_login=="Bendahara"){
              ?>
                  <li class="nav-item">
                    <a href="<?= site_url("/tagihan_mahasiswa") ?>"><i class="fas fa-columns"></i> <span>Tambahkan Tagihan</span></a>
              ...
              ?>
                    <li class="nav-item">
                      <a href="<?= site_url("/tagihan_saya") ?>"><i class="fas fa-columns"></i> <span>Tagihan Saya</span></a>
                      <a href="<?= site_url("/tagihan_saya/histori_transaksi") ?>"><i class="fas fa-columns"></i> <span>Histori Transaksi</span></a>
                    </li>
                <?php
                  }
                } 
